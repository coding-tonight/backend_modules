        ...
        <div class="card border-top border-0 border-4 border-dark">
            <div class="card-body p-5">
                <div class="card-title d-flex align-items-center">
                    <h5 class="mb-0">Add carousel</h5>
                </div>
                <hr>
                <form class="row g-3" method="post" action="{{ route('add.carousel') }}"
                            ...
                            <div class="card-body">
                                <div class="border p-3 rounded">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input id="fancy-file-upload" type="file" name="image" onchange="previewFile()"
                                            accept=".jpg, .png, image/jpeg, image/png" multiple  />
                                    </div>

                                    <div class="col-12 mb-2">
                                        <img src="{{ asset('no_image.jpg') }}" height="200"
                                            width="200"  class="thumbnail" alt="Thumbnail">
                                    </div>
                                    <div class="col-12">
